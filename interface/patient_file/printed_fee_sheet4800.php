...
#cssdos {font-family:mono; font-size: 14px;  position:relative; top:105px;}
#csspatname {font-family:mono;  font-size: 14px; position:relative; top:105px; left:15px; display: inline-block; width:250px;}
#cssdob {font-family:mono;  font-size: 14px; position:relative; top:105px; left:15px;}
#cssinsname {font-family:mono;  font-size: 14px; position:relative; top:105px; left:75px}
#cssrefname {font-family:mono;  font-size: 14px; position:relative; top:105px; left:75px}
.ftitletable {
width: 100%;
