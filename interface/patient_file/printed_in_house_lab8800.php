...
#csspatname { position:relative; top:5px; left:15px; display: inline-block; width:545px;}
#cssdocname { position:relative; top:5px}
...
//<td colspan='3' valign='top' class='fshead' style='height:${lheight}pt'>";
  ...
  //          $html .= "<br />";
            $html .= "<span id=cssdocname>" . $docresult['fname'] . '&nbsp;' . $docresult['lname'] . "</span>";
            $html .= "<br />";
            $html .= "<span id=csspatname>" . $patdata['DOB'] . "</span>";
            $html .= "<span id=cssdocname>" . $docresult['fname'] . '&nbsp;' . $docresult['lname'] . "</span>";
            $html .= "<br />";     
            $html .= "<span id=csspatname>" . $patdata['phone_home'] . "</span>";
            $html .= "<span id=cssdocname>" . $docresult['fname'] . '&nbsp;' . $docresult['lname'] . '&nbsp;'. $whichdate . "</span>";
