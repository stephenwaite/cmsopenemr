...
<a href="javascript:window.close();"><span class='title'><?php echo "Patient:  " . $titleres['fname'] . " " . $titleres['lname'] . "<br />" . "DOB:  " . $titleres['DOB_TS']; ?></span></a><br>

<?php xl('Generated on','e'); ?>: <?php echo oeFormatShortDate(); ?>
    ...
    ****/
        ...
        if ($key == "documents") {
            ...
            if (($auth_notes_a || $auth_notes || $auth_coding_a || $auth_coding || $auth_med || $auth_relaxed)) {
                ...
                if ($res[1] == 'newpatient') {
                  echo "<td><span class=bold>" . ("Date of Service: " . "</span>" . oeFormatSDFT(strtotime($dateres["date"])));
