		...
		<table style='border-left: 1px solid; width: 100%; height: 100%'>
			<tr>
				...
				<a href='#' class='css_button' onclick='window.print()'> 
                                ...
                                <a href='#' class='css_button' onclick='window.open("../patient_file/printed_fee_sheet" + siteid + ".php?fill=2","_blank")'> 
...
<table>
	...
	<?php if ($form_orderby == "pubpid") echo " style=\"color:#00cc00\"" ?>><?php  xl('DOB','e'); ?></a>
		</th>
